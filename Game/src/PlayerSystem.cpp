...
void PlayerSystem::add_bullet()
{
    ...
    _game->get_component_manager()->add_component<RigidBody2DComponent>(*e, { .velocity = {
                                                                                bullet_dir * VELOCITY_BULLET, 0.0f
                                                                            }
                                                                        });
    _game->get_component_manager()->add_component<Transform2DComponent>(*e, {.translation =
        {t->translation.x + (BULLET_REL_2_PLAYER_X * bullet_dir),t->translation.y + BULLET_REL_2_PLAYER_Y},.scale = {SCALE_BULLET, SCALE_BULLET}});
